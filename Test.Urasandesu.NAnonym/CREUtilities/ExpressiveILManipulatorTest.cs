...
{
    [TestFixture]
    public class ExpressiveILManipulatorTest
    {
        [TestFixtureSetUp]
        ...
        public void EmitTest01()
        {
            ...
            NewAppDomainTester.Using(newDomain =>
            {
                ...
                il =>
                {
                    il.Eval(_ => ThrowException("Hello, World!!"));
                });
        ...
        public void EmitTest02()
        {
            ...
            NewAppDomainTester.Using(newDomain =>
            {
                ...
                {
                    int i = default(int);
                    il.Eval(_ => _.Addloc(i, 100));
                    il.Eval(_ => ThrowException("i.ToString() = {0}", i.ToString()));
                });
        ...
        public void EmitTest03()
        {
            ...
            NewAppDomainTester.Using(newDomain =>
            {
                ...
                il =>
                {
                    ...
                    il.Eval(_ => _.Addloc(s, new string('a', 10)));
                    il.Eval(_ => ThrowException("s.ToString() = {0}", s.Substring(0, 5)));
                });
        ...
        public void EmitTest04()
        {
            ...
            NewAppDomainTester.Using(newDomain =>
            {
                ...
                il =>
                {
                    ...
                    il.Eval(_ => _.Addloc(s, new string('a', 10)));
                    il.Eval(_ => ThrowException("s.ToString() = {0}", s.ToUpper()));
                });
        ...
        public void EmitTest05()
        {
            ...
            NewAppDomainTester.Using(newDomain =>
            {
                ...
                il =>
                {
                    il.Eval(_ => ThrowException(SR.Emit.OpCodes.Brtrue));
                });
        ...
        public void EmitTest06()
        {
            ...
            NewAppDomainTester.Using(newDomain =>
            {
                ...
                il =>
                {
                    ...
                    int one = default(int);
                    il.Eval(_ => _.Addloc(one, 1));
                    il.Eval(_ => _.Addloc(stringBuilder, new StringBuilder()));
                    il.Eval(_ => stringBuilder.AppendFormat("{0}\r\n", string.Format("1 + 1 = {0}", one + 1)));
                    int i = default(int);
                    il.Eval(_ => _.Addloc(i, default(int)));
                    il.Eval(_ => stringBuilder.AppendFormat("{0}\r\n", string.Format("++i = {0}", _.AddOneDup(i))));
                    il.Eval(_ => stringBuilder.AppendFormat("{0}\r\n", string.Format("i++ = {0}", _.DupAddOne(i))));
                    il.Eval(_ => stringBuilder.AppendFormat("{0}\r\n", string.Format("--i = {0}", _.SubOneDup(i))));
                    il.Eval(_ => ThrowException(stringBuilder.ToString()));
                });
        ...
        public void EmitTest07()
        {
            ...
            NewAppDomainTester.Using(newDomain =>
            {
                ...
                il =>
                {
                    ...
                    il.Eval(_ => _.Addloc(dynamicMethod, new DynamicMethod("dynamicMethod", typeof(string), new Type[] { typeof(int) }, true)));
                    var stringBuilder = default(StringBuilder);
                    il.Eval(_ => _.Addloc(stringBuilder, new StringBuilder()));
        ...
        public void EmitTest08()
        {
            ...
            NewAppDomainTester.Using(newDomain =>
            {
                ...
                il =>
                {
                    ...
                    il.Eval(_ => _.Return(value + value * value));
                });
        ...
        public void EmitTest09()
        {
            ...
            NewAppDomainTester.Using(newDomain =>
            {
                ...
                il =>
                {
                    ...
                    il.Eval(_ => _.Addloc(d, 0d));
                    il.Eval(_ => _.Return(value + value * (int)d));
                });
        ...
        public void EmitTest10()
        {
            ...
            NewAppDomainTester.Using(newDomain =>
            {
                ...
                il =>
                {
                    il.Eval(_ => ThrowException("GetValue(10) = {0}", GetValue(10).ToString()));
                });
        ...
        public void EmitTest11()
        {
            ...
            NewAppDomainTester.Using(newDomain =>
            {
                ...
                il =>
                {
                    ...
                    il.Eval(_ => _.Addloc(ctor3, typeof(System.Func<,>).MakeGenericType(typeof(String), typeof(String)).GetConstructor(
                    ...
                    var stringBuilder = default(StringBuilder);
                    il.Eval(_ => _.Addloc(stringBuilder, new StringBuilder()));
                    il.Eval(_ => stringBuilder.AppendFormat("Name = {0}\r\n", ctor3.Name));
                    il.Eval(_ => stringBuilder.AppendFormat("IsPublic = {0}\r\n", ctor3.IsPublic));
                    var parameterInfos = default(ParameterInfo[]);
                    il.Eval(_ => _.Addloc(parameterInfos, ctor3.GetParameters()));
                    il.Eval(_ => stringBuilder.AppendFormat("Parameter Count = {0}\r\n", parameterInfos.Length));
                    il.Eval(_ => stringBuilder.AppendFormat("Parameter[0] = {0}\r\n", parameterInfos[0]));
                    il.Eval(_ => stringBuilder.AppendFormat("Parameter[1] = {0}\r\n", parameterInfos[1]));
                    il.Eval(_ => ThrowException(stringBuilder.ToString()));
                });
        ...
        public void EmitTest12()
        {
            ...
            NewAppDomainTester.Using(newDomain =>
            {
                ...
                il =>
                {
                    il.Eval(_ => ThrowException(i + (int)d));
                });
        ...
        public void EmitTest14()
        {
            ...
            //        il.il.Emit(OpCodes.Call, typeof(object).GetConstructor(new Type[] { }));
            //    });
        ...
        public void EmitTest15()
        {
            UsingTempFile(tempFileName =>
            {
                ...
                {
                    il.Eval(_ => _.Base());
                    il.Eval(_ => Console.WriteLine("Hello, dynamic assembly !!"));
                });
